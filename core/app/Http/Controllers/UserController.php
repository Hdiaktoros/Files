...
class UserController extends Controller
{
    ...
    public function home()
    {
        ...
        $totalDownloads = Download::where('user_id',auth()->user()->id)->count();
        $totalTransactions = Transaction::where('user_id',auth()->user()->id)->count();
        $latestDownloads = Download::where('user_id',auth()->user()->id)->latest()->limit(7)->with('product')->get();
        $emptyMessage = 'No data found';

        return view($this->activeTemplate . 'user.dashboard', compact('pageTitle','balance','totalDownloads','totalTransactions','latestDownloads','emptyMessage'));
    }
