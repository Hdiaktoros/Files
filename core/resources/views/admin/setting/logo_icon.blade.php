                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label class="form-control-label font-weight-bold">@lang('For Light Version') <span class="text-danger">*</span></label>
                                                    <div class="profilePicPreview logoPicPrev" style="background-image: url({{ getImage(imagePath()['logoIcon']['path'].'/logo_light.png', '?'.time()) }})">
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="profilePicUpload" id="profilePicUpload1" accept=".png, .jpg, .jpeg" name="logo_light">
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label class="form-control-label font-weight-bold">@lang('For Dark Version') <span class="text-danger">*</span></label>
                                                    <div class="profilePicPreview logoPicPrev bg--dark" style="background-image: url({{ getImage(imagePath()['logoIcon']['path'].'/logo_dark.png', '?'.time()) }})">
                                                        <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <label class="form-control-label font-weight-bold">@lang('Favicon') <span class="text-danger">*</span></label>
                                                    <div class="row">
                                                        <div class="col-sm-6">
