            ...
            <div class="row mb-none-30">
                ...
                <div class="col-lg-3 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--danger text-white">
                        <div class="widget-three__icon b-radius--rounded bg--white  box--shadow2">
                            <i class="lab la-product-hunt text-dark"></i>
                        </div>
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{$totalProduct}}</h2>
                            <p class="text--small">@lang('Total Product')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--white">
                        ...
                        <div class="widget-three__content">
                            <h2 class="numbers">{{$totalCategory}}</h2>
                            <p class="text--small">@lang('Total Category')</p>
                        </div>
                    </div><!-- widget-two end -->
                </div>
            </div>
