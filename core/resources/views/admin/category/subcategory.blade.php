...
@section('panel')
                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('File Format Count')</th>
                            ...
                            <tbody class="list">
                                @forelse ($subcategories as $item)
                                    <tr>
                                        ...
                                        <td data-label="@lang('File Format Count')">{{ $item->formats->count() }}</td>
                                        <td data-label="@lang('Action')">
                                            ...
                                            <a href="{{ route('admin.category.format',$item->id) }}" class="icon-btn btn--info mr-1" data-toggle="tooltip" title="@lang('File Format')" data-original-title="@lang('File Format')">
                                                <i class="las la-file-alt text--shadow"></i>
                                            </a>
    ...
    @push('breadcrumb-plugins')
        ...
        @if(request()->routeIs('admin.category.sub'))
            <form action="{{ route('admin.category.sub.search',$category->id) }}" method="GET" class="form-inline float-sm-right bg--white mt-2">
