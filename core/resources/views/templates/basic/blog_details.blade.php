                        ...
                        <div class="post__details pb-50">
                            <div class="post__header">
                                ...
                                <div class="post__thumb">
                                    <img src="{{ getImage('assets/images/frontend/blog/'.@$blog->data_values->image,'900x565') }}" alt="blog">
                                </div>
                                            ...
                                            <a href="{{ route('blog.details',[slug(__(@$item->data_values->title)),$item->id]) }}" class="widget__post">
                                                ...
                                                <div class="widget__post__content">
                                                    <h6 class="widget__post__title">
                                                        {{str_limit(__(@$item->data_values->title),45)}}
                                                    </h6>
...
@push('shareImage')
    ...
    <meta itemprop="image" content="{{ getImage('assets/images/frontend/blog/'.@$blog->data_values->image,'900x565') }}">

    <!-- Facebook Meta Tags -->
    <meta property="og:image" content="{{ getImage('assets/images/frontend/blog/'.@$blog->data_values->image,'900x565') }}"/>
    ...
    <meta property="og:image:type" content="{{ getImage('assets/images/frontend/blog/'.@$blog->data_values->image,'900x565') }}" />
