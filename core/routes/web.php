...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        //Manage File Formats
        Route::get('format/{id}/search', 'CategoryController@searchFormat')->name('category.format.search');
        Route::get('format/{id}', 'CategoryController@formats')->name('category.format');
        Route::post('format/new/{id}', 'CategoryController@storeFormat')->name('category.format.store');
        Route::post('format/update/{id}', 'CategoryController@updateFormat')->name('category.format.update');

        //Advertise
        Route::get('advertise', 'AdvertiseController@adds')->name('advertise');
        Route::post('advertise/store', 'AdvertiseController@addsStore')->name('advertise.store');
        Route::post('advertise/update/{id}', 'AdvertiseController@addsUpdate')->name('advertise.update');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            // Downloads
            Route::post('product/order', 'DownloadController@order')->name('order');
            Route::get('downloads', 'DownloadController@downloads')->name('downloads');
            Route::get('product/download/{id}', 'DownloadController@productDownload')->name('product.download');

            //Rating
            Route::post('rating', 'DownloadController@rating')->name('rating');
        });
    });
});
...
Route::get('loadmore/rating', 'SiteController@loadmoreRating')->name('loadmore.rating');

//Search Products
Route::get('product/search', 'SiteController@productSearch')->name('product.search');
Route::get('subcategory/search/{slug}/{id}', 'SiteController@subcategorySearch')->name('subcategory.search');
Route::get('category/search/{slug}/{id}', 'SiteController@categorySearch')->name('category.search');
...
// Company Policy
Route::get('policy/{id}', 'SiteController@policyDetails')->name('policy');
